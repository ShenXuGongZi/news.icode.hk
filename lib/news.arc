...
(= this-site*    "Geeker News"
   site-url*     "http://news.icode.hk/"
   parent-url*   "http://www.icode.hk"
   favicon-url*  ""
   site-desc*    "What this site is about."               ; for rss feed
   site-color*   (color 255 102 0)
   border-color* (color 255 102 0)
   prefer-url*   t)
...
(mac npage (title . body)
  `(tag html
     ...
     (tag body
       (center
         (tag (table border 0 cellpadding 0 cellspacing 0 width "55%"
                     bgcolor sand)
           ,@body)))))
...
(defop news.css req
  (pr "
body  { font-family:Verdana; font-size:10pt; color:#828282;background-image: url(bg.png); }
...
.title   { font-family:Verdana; font-size: 12pt; color:#828282; }
